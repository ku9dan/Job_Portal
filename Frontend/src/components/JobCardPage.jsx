...
const JobCardPage = () => {
  ...
  const jobs = [
    {
      ...
      description: 'Work on cutting-edge technologies and build scalable applications.',
    ...
    },
    {
      ...
      employmentType: 'Full-time',
      description: 'Develop and implement digital marketing strategies to drive growth.',
    ...
    },
    {
      ...
      description: 'Develop and maintain scalable software solutions for enterprise clients.',
    ...
    },
    {
      ...
      location: 'London, UK',
      employmentType: 'Contract',
      description: 'Analyze healthcare data to provide insights and improve patient outcomes.',
    ...
    },
    {
      ...
      description: 'Advise clients on renewable energy solutions and sustainability practices.',
    ...
    },
    {
      ...
      employmentType: 'Permanent',
      description: 'Design and develop engaging e-learning content for global audiences.',
      skills: ['Articulate Storyline', 'Learning Management Systems', 'Instructional Design'],
      salary: '$75,000',
      companyLogo: null,
    },
    {
      ...
      employmentType: 'Contract',
      description: 'Build and maintain blockchain-based financial applications.',
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-bold text-gray-900 mb-3">Job Listings</h1>
      <h3 className="text-l text-gray-900 mb-8">Find Jobs/Internships that suits your career aspiration</h3>
